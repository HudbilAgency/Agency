...
export default function Cursor() {
  ...
  useEffect(() => {
    const buttons = document.querySelectorAll(
      '.animation-slider, .whoweare-menu, .whatwedo-menu, .dropdown-menu, .dropdown-menu1, .dropdown-menu2, .dropdown-menu3, .dropdown-menu4, .dropdown-menu5, .dropdown-menu6, button, .content, .content2, .content3, .content4, .content5, .content6, .content7, .content8, a, [role="button"], [type="button"]'
    );
