...
const Footer2 = () => {
  ...
  return (
    <div className="bg-[#FCAB64] pt-6 pb-4">
      <div className="flex flex-col xl:flex-row gap-5 lg:gap-20 2xl:gap-28 mt-10 pl-6 sm:pl-16 xl:justify-center xl:items-center lg:px-28 2xl:px-68">
        <div>
          <div
