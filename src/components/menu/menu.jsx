...
const NavbarAndFullscreenMenu = () => {
  ...
  const controlNavbar = () => {
    // Ensure window object is available (this check is mostly for SSR frameworks like Next.js)
  ...
  const handlemenu3 = () => {
    ...
    // window.history.pushState({}, '', '/who-we-are');
  };
  ...
  return (
    <div className="flex h-32">
      <nav className={`navbar z-[100] ${show ? "active-menu" : ""}`}>
        <Link to={"/"}>
          <div
        ...
        <Link to="">
          <div className="menuButton mr-5 lg:mr-0 rotate-90 font-black">
      ...
      <div id="fullscreen-menu">
        <div
          id="redDiv"
          className="vertical-div z-[10000] pt-16 flex flex-col justify-between items-center red"
        >
          <h1 className=".align-h1 text-5xl font-black text-[#DF2323]">Home</h1>
          <ul>
            {/* <li className='pb-4 text-2xl text-white'><Link to='/about-us'>About Us</Link></li> */}
            <li
              onClick={handlemenu3}
              className="whoweare-menu cursor-pointer pb-4 text-2xl text-white text-center"
            >
              Who we are
            </li>
            <li
              onClick={handlemenu2}
              className="whatwedo-menu cursor-pointer pb-4 text-2xl text-white text-center"
            >
              What we do
            </li>
            <li className="pb-4 text-2xl text-white text-center">
              <Link to="/what-we-did">What we did</Link>
            </li>
            <li className="pb-4 text-2xl text-white text-center">
              <Link to="/what-we-charge">What we charge</Link>
            </li>
            <li className="pb-4 text-2xl text-white text-center">
              <Link to="/our-blogs">What we read</Link>
            </li>
            <li className="pb-4 text-2xl text-white text-center">
              <Link to="/contact-us">Where we are</Link>
            </li>
            <li className="pb-4 text-2xl text-white text-center">
              <Link to="/who-we-hire">Who we hire</Link>
            </li>
          </ul>
          <div className="flex flex-col gap-2 items-center pb-8">
            <div className="flex text-white relative gap-4">
              <div>
                <Link to="">
                  <svg
                    className="text-white opacity-75 flex justify-center items-center hover:scale-150 hover:opacity-100 transition-all rounded-full cursor-pointer"
              ...
              <div>
                <p className="text-xs text-white opacity-75 flex justify-center items-center hover:scale-150 hover:opacity-100 transition-all rounded-full cursor-pointer">
                  <Link to="">Fb</Link>
                </p>
              </div>
              <div>
            ...
            <div className=" left-[1.5%] w-[200px] h-[1.3px] bg-white"></div>
        ...
        <div
          id="yellowDiv"
          className="vertical-div hidden gap-8 sm:flex flex-col justify-between pt-16
           items-center yellow"
        >
          ...
          <div className="flex flex-col items-center justify-between gap-8 pb-52 2xl:pb-44">
            ...
            <div className="w-1/2 2xl:w-3/4">
              <a href="https://kalacode.com/">
                <img src="./menu-img2.png" />
              </a>
            </div>
            <div className="w-2/5 2xl:w-1/2 mx-auto h-[2px] bg-[#FCAB64]"></div>
            <div className="w-1/2 2xl:w-3/4">
              <a href="https://www.mausapp.com/">
                <img src="./menu-img3.png" />
              </a>
            </div>
            <div className="w-2/5 2xl:w-1/2 mx-auto h-[2px] bg-[#FCAB64]"></div>
        ...
        <div className="hidden lg:flex flex-col mb-4 w-fit">
          <a href="/">
            <div
              className="menu-logo pb-3"
              style={{
                marginTop: "10px",
                marginLeft: "10px",
                width: "186px",
          ...
          <div className="ml-[4px] xl:w-100 mr-auto xl:ml-[25%] 2xl:ml-[70%] mt-auto mb-auto">
            <div className="your-svg-container xl:ml-[25%]">
              <svg
                width="319"
                height="449"
                viewBox="0 0 319 449"
            ...
            <div
              className="impres w-auto 2xl:w-[380px] my-6 2xl:my-12"
              style={{
      ...
      <div id="fullscreen-menu2">
        <div
          id="whatwedo"
          className="main-menu-div inner-menu z-[10000] flex flex-col justify-between items-center sm:items-end"
        >
          <h1 className="whatwedomenutitle ml-auto text-5xl font-bold text-[#DF2323] leading-snug text-center sm:text-right mt-16 2xl:pt-12 sm:mr-10">
            What we do
          </h1>

          <div className="whatwedomenu flex flex-col gap-6 sm:gap-12 justify-center items-left w-fit ml-auto sm:ml-0 sm:mr-0 sm:justify-end px-4">
            <div className="flex sm:mx-32 flex-col sm:flex-row gap-6 sm:gap-0 items-left justify-center sm:items-end">
              <div className="menu-1 flex flex-col sm:mr-36 sm:w-2/3 ">
                <span className="text-white font-bold text-sm leading-3 mb-2.5">
                  01
                </span>
                <span className="text-[#1F1F21] sm:font-normal text-2xl sm:text-3xl leading-none w-fit">
              ...
              <div className="menu-2 flex flex-col ">
                ...
                <span className="text-[#1F1F21] font-normal text-2xl sm:text-3xl leading-none">
                  <Link to="/omni-channel-marketing">Channel Marketing</Link>
                </span>
              </div>
            </div>
            ...
            <div className="flex sm:mx-32 flex-col sm:flex-row gap-6 sm:gap-0">
              <div className="menu-1 flex flex-col sm:mr-36 sm:w-2/3">
                ...
                <span className="text-[#1F1F21] font-normal text-2xl sm:text-3xl leading-none">
                  <Link to="/hudbil-services">Hudbil Services</Link>
                </span>
              </div>
              <div className="menu-2 flex flex-col ">
                <span className="text-white font-bold text-sm leading-3 mb-2.5">
                ...
                <span className="text-[#1F1F21] font-normal text-2xl sm:text-3xl leading-none">
                  <Link to="/kalacode-services">Kalacode Services</Link>
                </span>
              </div>
            </div>
          </div>
        ...
        <div
          id="image-scroll1"
          className="hidden lg:flex mr-auto ml-[2%] xl:ml-[5%] 2xl:ml-[12%] imagetb-anm flex flex-col justify-center lg:w-[250px] xl:w-[400px] 2xl:w-[600px]"
        >
          <div className="wrap-menu-images">
