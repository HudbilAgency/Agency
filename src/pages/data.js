...
const images = [
  ...
  },
  {
    id: 2,
    src: qr2,
    description: "Spiderman into the spiderverse, spiderweb, 4k ",
  },
  {
    id: 3,
    src: qr3,
    description: "Tony Stark creates in a weaponized armor suit",
  },
  {
    id: 4,
    src: qr4,
    description:
      "Illustration of Barbie in a pink Dress, in barbieland, hyperdetailed, HD, 4k",
  },
  {
    id: 5,
    src: qr5,
    description:
      "The Hulk, highly detailed, digital painting, artstation, facing camera, concept art, smooth, sharp focus, illustration, art by artgerm and greg rutkowski, high definition digital art, dramatic lighting, in the style of ilya kuvshinov and Ross tran",
  },
  {
    id: 6,
    src: qr6,
    description:
      "A film still of a Atomic Bomb Blast from a Christopher Nolan film, Oppenheimer, Hyperdetailed, 4k",
  },
  {
    id: 7,
    src: qr7,
  ...
  },
  {
    ...
    src: qr8,
    description:
      "Fluffy dog,cute , 8k, ultra detail, highly intricate details, realistic light, ,",
  },
  {
    id: 9,
    src: qr9,
    description:
      "cute cat, brown color, kitty, big eyes, furry cat, cute paws,facing camera,4k, realistic, bright eyes",
  },
];
