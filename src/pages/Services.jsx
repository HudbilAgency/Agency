      ...
      <div className="flex sm:h-[85vh] h-full sm:flex-row flex-col sm:px-20 justify-center gap-20 items-center">
        <div className="sm:w-1/2 w-[90%]  mt-24 h-full m-auto text-white border-dashed  border-2    border-gray-600">
          ...
          <p className="sm:mt-3 sm:px-20 opacity-70 text-sm text-center  pb-5 px-5">
            Augmented reality is an interactive experience in which a real world
            environment is enhanced with computer-generated visual elements,
            sounds, and other stimuli. It can provide a user with a heightened,
            more immersive experience than they would experience otherwise that
            adds to the user's enjoyment or understanding.
          </p>
          ...
          <div className="text-center  flex justify-center mt-10 mb-10">
            ...
            >
              <button className="button_generate-now-services   ">
                Learn More
        ...
        <div className="sm:w-1/2 w-[90%] mt-24 h-full m-auto text-white border-dashed border-2 border-gray-600">
          ...
          <p className="sm:mt-3 sm:px-20 opacity-70 text-sm text-center  pb-5 px-5">
            ...
            processing, speech recognition and machine vision. We use deep
            learning, natural language process, AI technologies to meet the
            ever-growing business need for AI-powered products & services.{" "}
          </p>
          <div className="flex sm:flex-row flex-col gap-10 justify-around mt-10 w-[90%] m-auto items-center">
            <div className="sm:h-[230px] ">
              <img className="w-full h-full" src={qr} alt="" />
