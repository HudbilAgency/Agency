...
const Faq = () => {
  ...
  return (
    <div className="bg-[#F2F2F2]">
      ...
      <div className="px-6 py-8 sm:px-48 2xl:px-64 sm:py-16">
        <h1 className="text-7xl text-left leading-[6rem] text-[#DF2323] font-black">
          FAQ's
        </h1>
        <div className="flex flex-col gap-6 pt-10 text-xl sm:text-xl font-normal leading tight text[#1F1F21]">
          <p>
      ...
      <div className="px-6 py-4 sm:px-48 2xl:px-64 sm:py-10 flex flex-col gap-4">
        {questions.map(({ id, question, answer }) => (
          <div key={id} className="flex flex-col">
            <div className="flex">
              ...
              />
              <div
                className={`text-box font-medium text-xl md:text-xl gap-4 leading-tight text-[#1F1F21] px-6 sm:px-8 py-4 w-full flex justify-between ${
      ...
      <div className="px-6 py-4 sm:px-48 2xl:px-64 sm:py-10 flex flex-col">
